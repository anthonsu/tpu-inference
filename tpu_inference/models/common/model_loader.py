...
def get_flax_model(
    ...
    pooler = None
    if is_pooling:
        from vllm.model_executor.layers.pooler.pooler import Pooler
        pooler_config = getattr(vllm_config.model_config.hf_config, "pooler_config", None)
        if pooler_config is not None:
            pooler = Pooler.from_config(pooler_config)
